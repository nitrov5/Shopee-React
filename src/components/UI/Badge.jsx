...
const Badge = () => {
  return (
      <div className='cart bg-white w-0  group-hover:w-72 h-0 group-hover:h-72   transition-all absolute z-50 bottom-0 right-0 translate-y-full  shadow-md    group-hover:flex overflow-hidden'>

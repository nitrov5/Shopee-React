...
const Header = () => {
    return (
        <header className='lg:bg-orange-600  xl:px-40 lg:sticky  w-full'>
            {/* Nav mobile  */}
            ...
            <nav className='laptop-nav hidden  lg:flex justify-between items-center text-[13px] py-2 text-white'>
                <div className='left flex items-center gap-2'>
                    <a
                        href='#'
                        className="transition-all hover:opacity-60 flex gap-2 items-center after:content-['|'] after:h-full after:text-gray-200">
                        Kênh Người Bán
                    </a>
                    <a
                        href='#'
                    ...
                    <a
                        href='#'
                        className="transition-all hover:opacity-60 flex gap-2 items-center after:content-['|'] after:text-gray-200">
                        Tải ứng dụng
                    </a>
                ...
                <div className='right flex items-center gap-2'>
                    ...
                    <a
                        href='#'
                        className="transition-all hover:opacity-60 flex items-center gap-2 after:content-['|'] after:text-gray-200">
                        {" "}
                        Đăng Ký{" "}
                    </a>
                    <a href='#' className='transition-all hover:opacity-60'>
